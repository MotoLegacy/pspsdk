 ...
 *
 * main.c - Enhanced Input demo -- reads from control pad and indicates button
 *          presses. Supports DualShock 3 pressure sensitivity.
 *
 * Copyright (c) 2005 Marcus R. Brown <mrbrown@ocgnet.org>
 * Copyright (c) 2005 James Forshaw <tyranid@gmail.com>
 * Copyright (c) 2005 John Kelley <ps2dev@kelley.ca>
 * Copyright (c) 2005 Donour Sizemore <donour@uchicago.edu>
 * Copyright (c) 2025 Ivy Bowling <motolegacy@proton.me>
 *
 */
#include <pspkernel.h>
#include <pspdebug.h>
...
int main(void)
{
	...
	sceCtrl_driver_E467BEC8(PSP_CTRL_PORT_DS3, &transferHandler, NULL);
